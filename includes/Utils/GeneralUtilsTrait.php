<?php
namespace GPLSCore\GPLS_PLUGIN_WICOR\Utils;
...
trait GeneralUtilsTrait {
	...
	/**
	 * Check if proc_open available.
	 * @return bool
	 */
	public static function is_proc_open_available() {
		return ( \function_exists( 'proc_open' ) && ! in_array( 'proc_open', explode( ',', ini_get( 'disable_functions' ) ) ) );
	}
