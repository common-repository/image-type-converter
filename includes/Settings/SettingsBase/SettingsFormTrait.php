<?php
namespace GPLSCore\GPLS_PLUGIN_WICOR\Settings\SettingsBase;

defined( 'ABSPATH' ) || exit;

use GPLSCore\GPLS_PLUGIN_WICOR\Settings\SettingsFields\Field;
...
trait SettingsFormTrait {
	...
	public function form_close() {
		...
		?>
			<p class="submit">
				<button class="button-primary" type="submit" value="Save Changes"><?php esc_html_e( 'Save changes', '' ); ?></button>
	...
	public function save_field() {
		?>
		<input type="hidden" id="<?php echo esc_attr( $this->id . '-settings-save' ); ?>" name="<?php echo esc_attr( $this->id . '-settings-save' ); ?>" value="save" >
		<?php
	}
}
